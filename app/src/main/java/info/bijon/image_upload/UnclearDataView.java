...
public class UnclearDataView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_unclear_data_view);
        arrayList = new ArrayList<>();
        lv = (ListView) findViewById(R.id.unclearlist);
        final String url = getIntent().getStringExtra("urlid");
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                new UnclearDataView.ReadJSON().execute("http://appsticit.com/mucse/testtable.php?name="+url);
            }
        });
    }
        ...
        protected void onPostExecute(String content) {
            ...
            lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    String username = ((TextView) view.findViewById(R.id.txtName)).getText().toString();
                    Intent i = new Intent(UnclearDataView.this, UnclearItemView.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.viewLIST:
                ...
                Intent i = new Intent(UnclearDataView.this, Summary.class);
                startActivity(i);
                return true;
            ...
            case R.id.addperson:
                // Single menu item is selected do something
                // Ex: launching new activity/screen or show alert message
                Intent in = new Intent(UnclearDataView.this, Registration.class);
                startActivity(in);
                return true;
